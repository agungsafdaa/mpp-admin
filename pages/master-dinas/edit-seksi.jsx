...
export default function Tambah() {
    ...
    const dataSeksi = JSON.parse(router.query.dataSeksi)
    const idDinas = router.query.idDinas
    console.log(dataSeksi)
    const authenticated = isAuthenticated()
    const MySwal = withReactContent(Swal)
    const [state, setState] = useState({});
    const [progress, setProgress] = useState(false)
    const [loading, setLoading] = useState(true)
    const [value, setValue] = useState(dataSeksi.isActive);
    ...
    const tambahData = async () => {
        ...
        try {
            ...
            const response = await axios.put(url, {
                namaBidang:namaBidang,
                namaSeksi: dataSeksi.namaSeksi,
                namaSeksiEdit :state.namaSeksiEdit  === undefined ? dataSeksi.namaSeksi : state.namaSeksiEdit ,
                            ...
                            <Card className="card-mpp kategori-dinas">
                                <CardContent>
                                    ...
                                    <div className="heading">
                                        <h3>Edit {dataSeksi.namaSeksi}</h3>
                                    ...
                                    <div className="form-input">
                                        ...
                                        <TextField
                                            name="namaSeksiEdit"
                                            placeholder={dataSeksi.namaSeksi}
